...
export default function ChatScreen(props: any) {
  ...
  const { user } = useUser();
  const doctorName = route.params?.doctorName || 'الدكتور';
  const doctorId = route.params?.doctorId || 'default';
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <GlassCard style={styles.inputArea}>
          <TouchableOpacity style={styles.sendBtn} onPress={sendNewMessage}>
